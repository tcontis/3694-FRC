...
///
    ...
    CascadeClassifier faceDetector = new CascadeClassifier(Detection.class.getResource("haarcascade_frontalface_alt.xml").getPath().substring(1));
...
/////////
    ...
    public Detection() {
        initComponents();
        System.out.println(Detection.class.getResource("haarcascade_frontalface_alt.xml").getPath().substring(1));
    }
